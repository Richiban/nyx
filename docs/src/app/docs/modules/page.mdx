...
Modules in Nyx help organize code into logical units. They provide namespaces for definitions and control visibility.

## Module Declaration

Every Nyx file starts with a module declaration:
...
Nyx's standard library is organized into modules:
