...
But this feels a bit laborious. Nanyx has the concept of custom patterns, which we can use to
...
It's possible in Nanyx to pattern match on a partial tag union. This is what allows many of
