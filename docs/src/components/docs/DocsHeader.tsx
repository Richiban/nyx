      ...
      <div className="flex h-full items-center gap-4 px-4 md:px-6">
        ...
        <Link to="/" className="flex items-center gap-2.5 mr-auto">
          <div className="h-8 w-8 rounded-lg bg-primary flex items-center justify-center">
            <span className="text-primary-foreground font-bold text-sm" style={{ fontFamily: "'Space Grotesk', system-ui" }}>N</span>
          </div>
          <span className="text-lg font-bold tracking-tight" style={{ fontFamily: "'Space Grotesk', system-ui, sans-serif" }}>
            Nanyx
          </span>
        </Link>
        ...
        <button
          ...
          className="hidden md:flex items-center gap-2 h-9 px-3 text-sm text-muted-foreground border border-border rounded-lg hover:bg-accent transition-colors min-w-[220px]"
        >
