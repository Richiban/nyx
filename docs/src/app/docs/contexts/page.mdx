...
Contexts in Nyx provide a way to handle effects explicitly without threading parameters through every function. They're Nyx's take on algebraic effect handlers, designed to be simple yet powerful.
